...
GSpreadTree.GeneratorAPI = function() {}
GSpreadTree.GeneratorAPI.prototype = new BaseGen00.GeneratorAPI;
GSpreadTree.GeneratorAPI.prototype.identity = function() {
	return ('Gen01.SpreadTree.GeneratorAPI (' +this._dom.id+ ')');
};
GSpreadTree.GeneratorAPI.prototype.init = function() {
	this.generator = null;
...
GSpreadTree.GeneratorAPI.prototype.update = function()
{
...
GSpreadTree.GeneratorAPI.prototype.draw = function()
{
...
GSpreadTree.GeneratorAPI.prototype.tickSlower = function()
{
	this.generator.stepTime = this.generator.stepTime*1.5;
};
GSpreadTree.GeneratorAPI.prototype.tickFaster = function()
{
	this.generator.stepTime = this.generator.stepTime/1.5;	
};


GSpreadTree.GeneratorAPI.prototype.reframeCamera = function(cam, target, height)
{
...
GSpreadTree.GeneratorAPI.prototype.reframeCameraToCoord = function(cam, target, height)
{
...
GSpreadTree.GeneratorAPI.prototype.readInput = function(inputobj)
{
...
GSpreadTree.GeneratorAPI.alloc = function() {
	var vc = new GSpreadTree.GeneratorAPI();
	vc.init();
	return vc;
};
