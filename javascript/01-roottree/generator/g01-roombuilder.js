...
GSpreadTree.RoomBuilder = function() {}
GSpreadTree.RoomBuilder.prototype.identity = function() {
	return ('Gen01.SpreadTree.RoomBuilder ()');
};
GSpreadTree.RoomBuilder.prototype.init = function() {
	this.generator = null;
...
GSpreadTree.RoomBuilder.prototype.close = function() {
	this.generator = null;
...
GSpreadTree.RoomBuilder.prototype.openHall = function(target, height) {
...
GSpreadTree.RoomBuilder.prototype.buildArea = function( start, finish, height )
{
	this.spotsToAdd = [];
	this.pointsToDig = [];
	this.bordersUnvisited = [];
...
GSpreadTree.RoomBuilder.alloc = function() {
	var vc = new GSpreadTree.RoomBuilder();
	vc.init();
	return vc;
};
